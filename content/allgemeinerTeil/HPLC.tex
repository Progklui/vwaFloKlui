...
Die Herstellung eines Blattextraktes für die Analyse mit der \gls{hplc} herzustellen wird in \ref{sec:HPLCAufarbeitunderProbe} \nameref{sec:HPLCAufarbeitunderProbe} beschrieben. 
