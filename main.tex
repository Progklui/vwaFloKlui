...
\input{content/allgemeinerTeil/Themenstellung}   %% remove this line to get rid of the example chapter
\input{content/allgemeinerTeil/Das_Chlorophyll}
\input{content/allgemeinerTeil/Methoden}

\addpart{Experimenteller Teil}

\input{content/praktischerTeil/Praktischer_Teil_Allgemeine_Arbeitsmethoden}
\input{content/praktischerTeil/Praktischer_Teil_MS_LeafSpray}
\input{content/praktischerTeil/Praktischer_Teil_HPLC}
\input{content/praktischerTeil/Praktischer_Teil_Fragmentierung_MS_genau}

\addpart{Ergebnisse und Diskussion}

\input{content/Ergebnisse/Ergebnisse_und_Diskussion}
...
\input{content/Anhang/MSLeafspray/Anhang_MSLeafspray}
\input{content/Anhang/ESIMS/Anhang_ESIMS}
