...
\headerbox{Forschungsziele}{name=objectives,column=0,row=0}{
...
\headerbox{Einleitung}{name=introduction,column=1,row=0,bottomaligned=objectives}{
...
\headerbox{Ergebnisse II - Fragmentierungsdiagramme}{name=results,column=2,span=2,row=0}{
...
\captionof{figure}{Reaktionsprodukt des \textit{Bo}-DNCC}
\end{center}
...
\headerbox{Literatur}{name=references,column=0,above=bottom}{
...
\headerbox{Weitere Forschung}{name=futureresearch,column=1,span=2,aligned=references,above=bottom}{ % This block is as tall as the references block
...
\headerbox{Kontakt}{name=contact,column=3,aligned=references,above=bottom}{ % This block is as tall as the references block
...
\headerbox{Zusammenfassung}{name=conclusion,column=2,span=2,row=0,below=results,above=references}{
...
\headerbox{Materialien \& Methoden}{name=method,column=0,below=objectives,bottomaligned=conclusion}{ % This block's bottom aligns with the bottom of the conclusion block
...
\headerbox{Ergebnisse I}{name=results2,column=1,below=objectives,bottomaligned=conclusion}{ % This block's bottom aligns with the bottom of the conclusion block
